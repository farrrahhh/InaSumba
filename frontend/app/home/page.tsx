...
export default function ChatbotLanding() {
  ...
  return (
    <div className="min-h-screen max-h-screen relative overflow-hidden">
      ...
      {/* Title */}
      <div
        className={`absolute top-4 md:top-8 left-0 right-0 text-center z-20 transition-all duration-1000 ${
          ...
          >
            <div className="relative">
              <Image
                ...
                width={480}
                height={600}
                className="w-[280px] md:w-[360px] lg:w-[440px] h-auto drop-shadow-2xl hover:scale-105 transition-transform duration-300"
                priority
              />
      ...
      {!isLoaded && (
        <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-gray-800 flex items-center justify-center z-20">
          <div className="text-white text-center">
            ...
            <p className="text-sm opacity-80 mt-2">Menyiapkan percakapan dengan Ina Na</p>
          </div>
        </div>
      )}
    </div>
