...
interface ImageUploadClassifierProps {
  onImageUpload: (file: File) => void
  isLoading?: boolean
}

export default function ImageUploadClassifier({ onImageUpload, isLoading }: ImageUploadClassifierProps) {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-green-100">
      <h1 className="text-3xl font-bold text-center text-amber-800 mb-8">Ina Tenun</h1>
      ...
      <p className="text-center text-gray-600 mt-6 text-sm leading-relaxed">
        Drag or upload an image to analyze the pattern of Sumba s tenun.
      </p>
    </div>
  )
}
